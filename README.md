# React_Plotly_Practice
my practice of building a weather app with React, Redux and Plotly.
**************************

It's an interesting experience includes extract data using api, process and deal with changing weather data in graphs, etc.

Branch: example contains the basic React App based on this useful tutorial:
http://academy.plot.ly/react/1-introduction/
http://academy.plot.ly/react/2-first-app/
http://academy.plot.ly/react/3-with-plotly/
http://academy.plot.ly/react/4-redux-state-management/
http://academy.plot.ly/react/5-immutable-data/
